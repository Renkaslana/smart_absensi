...
export const absensiAPI = {
  ...
  adminSubmit: async (data: { image_base64: string; user_id?: number }) => {
    // Use dedicated admin endpoint for submitting attendance on behalf of students
    return api.post('/api/v1/admin/submit-attendance', { image_base64: data.image_base64 });
  },

  getHistory: async (params?: { page?: number; page_size?: number; skip?: number; limit?: number; start_date?: string; end_date?: string }) => {
